...
I've watched you keep going when everything was giving you reasons to stop.
...
You smile. Even when life isn't requring a smile from you.

So when the days feel heavier than you can bear, coz they do. Remember that you're you.

Keep your chin up high. Smile, be Happy. And always know I got you covered in prayer.
...
And we're are not there to keep track of the changes.
...
const memorySection = document.getElementById("our-memories");
...
observer2.observe(memorySection);
...
video1.muted=true;
video1.loop=true;
video1.style.filter= "grayscale(70%) blur(0.2px)"
